...
// 			System.out.println(path);
			...
			if(file.exists()){
        %>
			<img src='upload/<%= rs.getString(23)%>' style="width: 113px;height: 150px;float: right;" alt="Profile Image"/>
		<%  }else{ %>
    		<img src="upload/default.png" style="width: 113px;height: 150px;float: right;" alt="Profile Image"/>
    	<%  }  %>
		</div>
					</div>
		<div class="clearfix"></div>
