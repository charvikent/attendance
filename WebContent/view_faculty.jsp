...
<head>
  ...
  <title>Faculty | View Faculty Profile</title>
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="open has_sub">
            ...
            <ul>
              <li class="current"><a href="view_faculty.jsp">View Profile</a></li>
...
<!-- 			<form action="" method="post"> -->
              ...
              <tbody>
<%
ps=con.prepareStatement("select * from faculty where faculty_name='"+uname+"'");
ResultSet rs1=ps.executeQuery();
if(!rs1.isBeforeFirst())
{
  %>
      <tr>
          <td colspan="8"><% out.print("<h3 style='color:red;text-align:center'>No Results found!</h3>"); %></td>
      </tr>
  <%
}    
else
