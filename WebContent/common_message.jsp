...
<head>
  ...
  <title>Administrator | Student(s) Common Message</title>
...
<div class="content">
        ...
        <ul id="nav">
          ...
          <li class="open has_sub">
            ...
            <ul>
              ...
              <li class="current"><a href="common_message.jsp">Common Message</a></li>
 ...
 <div class="right_col" role="main">
	...
	<form id="msg-form" data-parsley-validate="" class="form-horizontal form-label-left" method="post" action="SendSMSEmail">
                     <div class="col-lg-12">
<!--                      	<div class="col-lg-10"> -->
