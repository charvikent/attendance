...
<head>
  ...
  <title>Parent | View Children(s) List</title>
...
<!--               <li class=""><a href="export_faculty.jsp">Export Faculty</a></li> -->
          ...
          <li class="open has_sub">
            ...
            <ul>
              <li class="current"><a href="parent_views_student.jsp">View Students</a></li>
            </ul>
          </li> 
          <li class="has_sub">
...
<!--                         <th><input id="checkAll" type="checkbox" class="checkbox" name="checkall" onclick="checkDelete()"></th> -->
              ...
              <tbody>
<%
ps=con.prepareStatement("select * from addstudent where father_name='"+uname+"'");
