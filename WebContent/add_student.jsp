...
<head>
  ...
  <script src="js/respond.min.js"></script> <!-- jQuery -->
  <!--[if lt IE 9]>
...
%>
                    ...
                    <!-- Form starts.  -->
                     <form id="demo-form2" action="StudentRegistration" name="studentform" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                     <div class="col-lg-12">
                              <div class="col-lg-8">
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <% if(nam != null) { %> value="<%= nam %>" <% } %> required>
<!--                                     <span id="name-error" class="has-error"></span> -->
                                  </div>
                                </div>
...
<!--                                     <span id="board-error" class="has-error"></span> -->
                                  </div>
                                </div>    
...
<!--                                     <span id="medium-error" class="has-error"></span> -->
                                  </div>
                                </div> 
...
<!--                                     <span id="class-error" class="has-error"></span> -->
                                  </div>
                                </div>  
...
<!--                                     <span id="section-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                    <input type="text" class="form-control" placeholder="Enter Roll Number" onblur="this.placeholder='Enter Roll Number'" id="rollno" name="rollno" 
                                    <% if(rlno != null) { %> value="<%= rlno %>" <% } %> required>
<!--                                     <span id="rollno-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                    <input type="text" class="form-control" placeholder="Enter Admission No." id="admissionno" name="admissionno" 
                                    <% if(adno != null) { %> value="<%= adno %>" <% } %> required>
<!--                                     <span id="admissionno-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                    <input type="text" class="form-control" placeholder="Enter Father Name" id="fname" name="fname" 
                                    <% if(fnam != null) { %> value="<%= fnam %>" <% } %> required>
<!--                                     <span id="fname-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                    <input type="text" class="form-control" placeholder="ex:8888888888" onblur="this.placeholder='Enter Mobile Number'" id="mobile" name="mobile" 
                                    <% if(mbl != null) { %> value="<%= mbl %>" <% } %> required>
<!--                                     <span id="mobile-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                  ...
                                  <div class="col-lg-6">
                                    <input type="text" class="form-control" placeholder="ex:9999999999" onblur="this.placeholder='Enter Alternate Number'" id="altmobile" name="altmobile" 
                                    <% if(altr != null) { %> value="<%= altr %>" <% } %> />
<!--                                     <span id="altmobile-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                  ...
                                  <div class="col-lg-6">
                                    <input type="email" id="email" name="email" placeholder="john@email.com" class="form-control" onblur="this.placeholder='Enter Email Id'" 
                                    <% if(eml != null) { %> value="<%= eml %>" <% } %> />
<!--                                    <span id="email-error" class="has-error"></span> -->
                                  </div>
                                </div>
...
<!--                                     <span id="bgroup-error" class="has-error"></span> -->
                                  </div>
                                </div>
...
<!--                                     <span id="gender-error" class="has-error"></span> -->
                                  </div>
                                </div>
									...
									<label for="dob" class="col-lg-4 control-label">Date Of Birth</label>
                                  	<div class="col-lg-6">
										<div  id="datetimepicker1" class="input-append input-group dtpicker">
		                                  	<input data-format="yyyy-MM-dd" type="text" class="form-control" placeholder="YYYY-MM-DD" name="dob" id="dob" 
		                                  	<% if(db != null) { %>value="<%= db %>" <% } %> required>
											<span class="input-group-addon add-on">
	                                        	<i data-time-icon="fa fa-times" data-date-icon="fa fa-calendar" class="fa fa-calendar"></i>
	                                      	</span>
	                                    </div>
	                                    	<span class="dob_error"></span>
<!--                                       	<span id="dob-error" class="has-error"></span> -->
                                  	</div>
                                </div>
...
<!--         							<span id="religion-error" class="has-error"></span> -->
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                	<label class="col-lg-4 control-label">Address</label>
                                  	<div class="col-lg-6">
                                    	<textarea id="address" name="address" class="form-control" rows="5" placeholder="Enter Address" 
                                    	<% if(adr != null) { %> value="<%= adr %>" <% } %> required></textarea>
<!--                                     	<span id="address-error" class="has-error"></span> -->
                                  	</div>
                                </div>  
                                ...
                                <div class="form-group">
                                	<label class="col-lg-4 control-label">Previous Institute</label>
                                  	<div class="col-lg-6">
                                    	<input type="text" class="form-control" placeholder="Enter Previous Institute" id="pinstitute" name="pinstitute" 
                                    	<% if(pri != null) { %>value="<%= pri %>" <% } %> />
<!--                                     	<span id="pinstitute-error" class="has-error"></span> -->
                                  	</div>
                                </div>
...
<!-- 								        <span id="caste-error" class="has-error"></span> -->
                                  	</div>
                                </div>
...
<!--                                     	<span id="accomodation-error" class="has-error"></span> -->
                                  </div>
                                </div>
...
<!--                                   		<span id="busfacility-error" class="has-error"></span> -->
                                  	</div>
                                </div>
                                <div id="divdisp"></div>
								...
								<div class="form-group" id="disp">
                                	<label class="col-lg-4 control-label">Bus Route</label>
                                  	<div class="col-lg-6">
                                    	<input type="text" class="form-control" placeholder="Please Enter Bus route" name="busroute" id="busroute" 
                                    	<% if(busrt != null) { %>value="<%= busrt %>" <% } %> />
								...
								<div class="form-group">
		                      		<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4"  >
				                        <button type="submit" class="btn btn-info" name="submit" id="submit" onclick="return registration()">Submit</button>
		...
		var regex = new RegExp("(.*?)\.(png)$");
 		if(!(regex.test(val))) 
 		{
			...
			alert('Please Select .png format only..!');
					...
					<div class="col-lg-4">
						<div class="form-group" >
       						<img id="blah" src='upload/default.png' alt="Image size should be (width X height) 240X320" align="middle" 
       						style="border-style: solid;height: 160px;width: 135px;border-bottom-style: none;border-left-style: none;border-top-style: none;">
     						<label for="fileImage" class="col-lg-4 control-label">Student Image</label>
      						...
      						<div class="clear-fix"></div>
     							<span style="margin-top: 1.5em;margin-left: 1.25em;" class="fileImage-error"></span>
     							<span style="margin-top: 1.5em;margin-left: 1.25em;" class="fileImaged_error"></span>
