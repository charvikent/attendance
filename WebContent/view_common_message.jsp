...
<head>
  ...
  <title>Administrator | View Common Messages</title>
...
<div class="content">
        ...
        <ul id="nav">
          ...
          <li class="open has_sub">
            ...
            <ul>
              ...
              <li class="current"><a href="view_common_message.jsp">View Common Messages</a></li>
 ...
 <div class="right_col" role="main">
	...
	<div id="view_list">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left"><i class="fa fa-home"></i> Message</h2>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <div class="form quick-post">
                          ...
                          <form id="att-form" action="view_common_message.jsp" class="form-horizontal form-label-left" method="post" role="form">
...
if(from != null && !from.equals("") )
{
	...
	sql.append("select * from notification where ");
	if(from != null && !from.equals("")){
		sql.append("  Date(sent_on) >='"+from+"' ");
	}
	if( from != null && !from.equals("") && to != null && !to.equals("")){
		sql.append(" and Date(sent_on) <='"+to+"' ");
	}
	if( from == null && from.equals("") && to != null && !to.equals("")){
		sql.append("  Date(sent_on) <='"+to+"' ");
	}
...
<%--           <td><%= rs.getString(8)%></td> --%>
          <td>
          	<%if(rs.getString(9).equals("admin")){ %>
          		<%= rs.getString(9)%>
          	<% } else { %>
          		<a style="cursor: pointer;" onClick="getFaculty(<%= rs.getString(8) %>)"><%= rs.getString(9)%></a>
          	<% } %>
          </td>
...
<%--           <td><%= rs1.getString(8)%></td> --%>
          <td>
          	<%if(rs1.getString(9).equals("admin")){ %>
          		<%= rs1.getString(9)%>
          	<% } else { %>
          		<a style="cursor: pointer;" onClick="getFaculty(<%= rs1.getString(8) %>)"><%= rs1.getString(9)%></a>
          	<% } %>
          </td>
