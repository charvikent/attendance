...
<head>
  ...
  <title>Parent | View Children(s) Notification</title>
...
<!--               <li class=""><a href="export_faculty.jsp">Export Faculty</a></li> -->
          ...
          <li class="open has_sub">
            ...
            <ul>
              ...
              <li class="current"><a href="parent_view_notification.jsp">Notification</a></li>
...
<!--                         <th><input id="checkAll" type="checkbox" class="checkbox" name="checkall" onclick="checkDelete()"></th> -->
              ...
              <tbody>
<%
ps=con.prepareStatement("select * from notification where father_name='"+uname+"'");
