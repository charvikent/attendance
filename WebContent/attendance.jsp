...
<head>
  ...
  <title>Administrator | Student Attendance</title>
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="open has_sub">
            ...
            <ul>
              <li class="current"><a href="attendance.jsp">Attendance</a></li>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <div class="form quick-post">
                          ...
                          <form id="msg-form1" action="attendance.jsp" class="form-horizontal form-label-left" method="post" role="form">
                          <!-- Name -->
...
<form id="msg-form2" action="SendSMSEmail" method="post">
<div class="col-md-12">
<!-- Quick setting -->
<div class="widget">
  <div class="widget-head">
...
%>
	...
	<div class="form-group">
    	<div class="col-md-3 col-sm-6 col-xs-12" style="float: right;">
        	<a style="float: right;" href="attendance.jsp"><button id="reset" name="reset" type="button" class="btn btn-danger">Cancel</button></a>
		</div>
	</div>
    <br>
<%
...
// 			System.out.println(path);
            File file=new File(path+rs.getString(8)+".png");
			if(file.exists()){
        %>
