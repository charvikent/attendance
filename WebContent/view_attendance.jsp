...
<head>
  ...
  <title>Administrator | View Attendance</title>
        ...
        <ul id="nav">
          ...
          <li class="open has_sub">
            ...
            <ul>
              ...
              <li class="current"><a href="view_attendance.jsp">View Attendance</a></li>
     ...
     <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="javascript:void(0)" class="bread-current">View Attendance</a>
        </div>
			...
			<div class="col-md-6 col-md-offset-2">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Search Students Attendance</div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <div class="form quick-post">
                          ...
                          <form id="att-form" action="view_attendance.jsp" class="form-horizontal form-label-left" method="post" role="form">
...
if(from != null && !from.equals("") )
{
	...
	sql.append("select * from attendance where ");
	if(from != null && !from.equals("")){
		sql.append("  Date(absent_on) >='"+from+"' ");
	}
	if( from != null && !from.equals("") && to != null && !to.equals("")){
		sql.append(" and Date(absent_on) <='"+to+"' ");
	}
	if( from == null && from.equals("") && to != null && !to.equals("")){
		sql.append("  Date(absent_on) <='"+to+"' ");
	}
	...
	<%--           <td><%= rs1.getString(10)%></td> --%>
	          <td><a style="cursor: pointer;" onClick="getFaculty(<%= rs.getString(10)%>)"><%= rs.getString(11)%></a></td>
	          <td>
		          <% if(rs.getString(8).equals("absent")) { %>
...
<%--           <td><%= rs1.getString(7)%></td> --%>
<%--           <td><%= rs1.getString(10)%></td> --%>
          <td><a style="cursor: pointer;" onClick="getFaculty(<%= rs1.getString(10)%>)"><%= rs1.getString(11)%></a></td>
          <td>
  ...
  function getFaculty(id)
	{
		...
		$.ajax({
	   		type:"GET",
	   		url:"get_faculty_data.jsp?id="+id,
	   		data: "",
	   		success:function(data)
	   		{
				if(data!="")
