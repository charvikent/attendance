...
<head>
  ...
  <title>Administrator | Subject Creation</title>
...
<div class="content">
 ...
 <div class="right_col" role="main">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a  class="bread-current">General Settings</a>
          </div>
            <div class="clearfix"></div>
      </div>
          ...
          <div class="col-md-6 col-md-offset-2">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Subject Creation</div>
...
%>                    
                    <div class="form quick-post">
                                      ...
                                      <form id="demo-form2" action="SubjectCreation" data-parsley-validate class="form-horizontal form-label-left" method="post" role="form">
                          <!-- Name -->
                          <div class="form-group">
	                          <label class="control-label col-md-3" for="sitename"> Subject Name</label>
	                          <div class="col-md-6">
		                      	<input type="text" required="required" placeholder="Enter Subject Name" class="form-control" name="subject_name" id="subject_name" 
		                      	<% if(sub_name != null) { %>value="<%= sub_name %>" <% session.setAttribute("sub_name", null); } %>>
        ...
        <%
            ...
            if(subject_name != null)
            {
            	...
            	{
            		ps = con.prepareStatement("insert into subjectcreation values(null,'"+subject_name+"')");
	            	i = ps.executeUpdate();
	            	if(i>=0)
	            	{
	            		session.setAttribute("added", "Successfully Subject is Created");
	                    response.sendRedirect("SubjectCreation");
	            	}
	                else
	                {
	                    session.setAttribute("error", "Faied to Create the Subject");
	                    response.sendRedirect("SubjectCreation");
	                }
            	}
        	}
