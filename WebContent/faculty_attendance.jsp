...
<!--               <li class=""><a href="export_faculty.jsp">Export Faculty</a></li> -->
          ...
          <li class="open has_sub">
            ...
            <ul>
<!--               <li class="current"><a href="faculty_attendance.jsp">Attendance</a></li> -->
...
<!--               <li class=""><a href="faculty_view_attendance.jsp">View Attendance</a></li> -->
              <li class=""><a href="faculty_view_common_message.jsp">Common Message</a></li>
          ...
          <div class="col-md-6 col-md-offset-2">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Generate Attendance</div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <div class="form quick-post">
                          ...
                          <form id="msg-form1" action="faculty_attendance.jsp" class="form-horizontal form-label-left" method="post" role="form">
                          <!-- Name -->
...
<form id="msg-form2" action="Faculty_SendSMSEmail" method="post">
<div class="col-md-12">
<!-- Quick setting -->
<div class="widget">
  <div class="widget-head">
    <div class="pull-left">Send Message/Email</div>
    <div class="widget-icons pull-right">
...
%>
	...
	<div class="form-group">
    	<div class="col-md-3 col-sm-6 col-xs-12" style="float: right;">
        	<a style="float: right;" href="faculty_attendance.jsp"><button id="reset" name="reset" type="button" class="btn btn-danger">Cancel</button></a>
		</div>
	</div>
    <br>
<%
...
// 			System.out.println(path);
		...
		<%-- <td>
			<a href="send_email.jsp?sno=<%= rs.getString(1)%>">
              <i class='fa fa-envelope fa-2'></i>&nbsp;Send E-mail
            </a>
		</td> --%>
	</tr>
	<% } %>
    ...
    <span class="student_id_error" id="student_id_error"></span>
    <label id="student_id[]-error" class="error" for="student_id[]" style="color: rgb(255, 0, 0);font-weight: normal;"></label>
    </div>
	...
	<div class="form-group" id="absess">
		<div class="control-group">
			<label class="col-lg-3 control-label" style="text-align: right;">Absent Session &nbsp; &nbsp;</label>
            <div class="col-md-3 col-sm-3 col-xs-6">
				<select class="form-control select_class" name="absent_session" id="absent_session" aria-required="true" required>
					<option value="" selected disabled>-- Select --</option>
					<option value="fullday">Full Day</option>
					<option value="morning">Morning Session</option>
					<option value="afternoon">Afternoon Session</option>
				</select>
				<span class="absent_session_error" id="absent_session_error"></span>
				<label id="absent_session-error" class="error" for="absent_session" style="color: rgb(255, 0, 0);font-weight: normal;"></label>
			</div>
		</div>
	</div>
	<br><br>
	...
	<div class="form-group" id="mess">
		<div class="control-group">
			<label class="col-lg-3 control-label" style="text-align: right;">Message &nbsp; &nbsp;</label>
            <div class="col-lg-5">
	        	<textarea name="messagedata" id="messagedata" style="margin: 0px; width: 212px; height: 75px;" required>Dear #2, your child #1 is absent today. Please send your child regularly.</textarea>
	            <div class="clearfix"></div>
	...
	<div class="form-group" id="stu1">
		<div class="control-group">
			<label class="control-label col-lg-3 col-sm-3 col-xs-12" style="text-align: right;">&nbsp; &nbsp;</label>
	        <div class="col-md-3 col-sm-3 col-xs-6">
	        	<b>#1 - Student name</b>
	       	</div> 
		</div>
	...
	<div class="form-group">
		<div class="control-group">
			<label class="col-lg-3 control-label" style="text-align: right;">Notification Type  &nbsp; &nbsp;</label>
			<div class="col-md-3 col-sm-3 col-xs-6">
				<select class="form-control select_class" name="notify_type" id="notify_type" aria-required="true" required>
					<option value="" selected disabled>-- Select --</option>
					<option value="sms">SMS</option>
					<option value="em">Email</option>
					<option value="smem">SMS+Email</option>
				</select>
				<span class="notify_type_error" id="notify_type_error"></span>
				<label id="notify_type-error" class="error" for="notify_type" style="color: rgb(255, 0, 0);font-weight: normal;"></label>
			</div>
		</div>
	</div>
	<br><br>
	...
	<div class="form-group">
    	<div class="col-md-3 col-sm-6 col-xs-12 col-md-offset-3">
			<button type="submit" class="btn btn-info" id="send" name="send">Send</button>
        	<a href="attendance.jsp"><button id="reset" name="reset" type="button" class="btn btn-default">Cancel</button></a>
		</div>
	</div>
    <br>
<% } %>
