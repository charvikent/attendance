...
<head>
  ...
  <title>Faculty | View Student(s) List</title>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class=""><a href="facultyhome.jsp"><i class="fa fa-home"></i> Dashboard</a>
            <!-- Sub menu markup 
            <ul>
...
<!--               <li class=""><a href="export_faculty.jsp">Export Faculty</a></li> -->
          ...
          <li class="open has_sub">
            ...
            <ul>
              <li class="current"><a href="faculty_view_student.jsp">View Students</a></li>
            </ul>
          </li> 
          <li class="has_sub">
...
<!--                         <th><input id="checkAll" type="checkbox" class="checkbox" name="checkall" onclick="checkDelete()"></th> -->
              ...
              <tbody>
<%
String board_name=null,medium=null,class_name=null,section=null;
ps=con.prepareStatement("select board_name,medium,class_name,section from faculty where faculty_name='"+uname+"'");
ResultSet rst=ps.executeQuery();
if(rst.next())
{
	board_name=rst.getString(1);	medium=rst.getString(2);	class_name=rst.getString(3);	section=rst.getString(4);
}

ps=con.prepareStatement("select * from addstudent where board_name='"+board_name+"' and medium='"+medium+"' and class_name='"+class_name+"' and section='"+section+"'");
