...
<head>
  ...
  <title>Administrator | Create Class</title>
  ...
  <div class="col-md-6 col-md-offset-2">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Class Creation</div>
...
%>                    
                    <div class="form quick-post">
                          ...
                          <form id="demo-form2" action="ClassCreation" class="form-horizontal form-label-left" method="post" role="form">
                          <!-- Name -->
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 ">
                        	<select class="form-control col-md-7 col-xs-12" name="board_name" id="board_name">
	                          ...
	                          <option <% if(b_name != null && b_name.equals("SSC")) { %> value="SSC" selected <% session.setAttribute("b_name", null); } %>>SSC</option>
	                          <option <% if(b_name != null && b_name.equals("CBSE")) { %> value="CBSE" selected <% session.setAttribute("b_name", null); } %>>CBSE </option>
	                          <option <% if(b_name != null && b_name.equals("ICSE")) { %> value="ICSE" selected <% session.setAttribute("b_name", null); } %>>ICSE</option>
	                          <option <% if(b_name != null && b_name.equals("IB")) { %> value="IB" selected <% session.setAttribute("b_name", null); } %>>IB </option>
   							</select>
                        ...
                        <div class="col-lg-6 ">
                        	<select class="form-control col-md-7 col-xs-12" name="medium_name" id="medium_name" required>
                        		<option value="" selected disabled>Choose Medium</option>
                          		<option <% if(m_name != null && m_name.equals("English")) { %>value="English" selected <% session.setAttribute("m_name", null); } %>>English</option>
		                        <option <% if(m_name != null && m_name.equals("Telugu")) { %> value="Telugu" selected <% session.setAttribute("m_name", null); } %>>Telugu</option>
	    	                    <option <% if(m_name != null && m_name.equals("Hindi")) { %> value="Hindi" selected <% session.setAttribute("m_name", null); } %>>Hindi</option>
	        	                <option <% if(m_name != null && m_name.equals("Urdu")) { %> value="Urdu" selected <% session.setAttribute("m_name", null); } %>>Urdu</option>
							</select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                        	<input type="text" placeholder="Enter Class Name" class="form-control col-md-7 col-xs-12" name="class_name" id="class_name"
                        	<% if(c_name != null) { %>value="<%= c_name %>" <% session.setAttribute("c_name", null); } %>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                        	<input type="text" placeholder="Enter Section Name" class="form-control col-md-7 col-xs-12" name="section_name" id="section_name"
                        	 <% if(s_name != null) { %>value="<%= s_name %>" <% session.setAttribute("s_name", null); } %>>
	...
	<%
            ...
            if(board_name !=null && medium_name != null && class_name != null && section_name != null)
            {
            	...
            	{
	            	ps=con.prepareStatement("insert into classcreation values(null,'"+board_name+"','"+medium_name+"','"+class_name+"','"+section_name+"')");
	            	i=ps.executeUpdate();
	            	if(i>=0)
	            	{
	            		session.setAttribute("added", "Successfully Class is Created");
	                    response.sendRedirect("ClassCreation");
	            	}
	                else
	                {
	                    session.setAttribute("error", "Faied to Create the Class");
	                    response.sendRedirect("ClassCreation");
	                }
            	}
        	}
...
%>
          ...
          <td align='center'>
            ...
            <a href="ClassCreation?slno=<%= rs1.getString(1)%>" onClick="return confirm('Are you sure you want to Delete');">
