    ...
    <div class="conjtainer">
      <!-- Menu button for smaller screens -->
 		<div class="navbar-header">
		  ...
		  <a href="parenthome.jsp" class="navbar-brand hidden-lg">Attendance Management System</a>
		</div>
        ...
        <!-- Links -->
         <div class="col-md-6">
          ...
          <div class="logo hidden-sm hidden-xs">
            <h2><a class="" href="parenthome.jsp">Attendance Management System</a></h2>
            <p class="meta"></p>
          </div>
          <!-- Logo ends -->
        </div>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="open"><a href="parenthome.jsp"><i class="fa fa-home"></i> Dashboard</a></li>
          <li class="has_sub">
...
<!--               <li class=""><a href="export_faculty.jsp">Export Faculty</a></li> -->
 ...
 <div class="right_col" role="main">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="parenthome.jsp" class="bread-current">Dashboard</a>
        </div>
